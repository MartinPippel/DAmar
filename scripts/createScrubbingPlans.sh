...
function setLAseparateOptions()
{
    ...
    then 
		...
		RAW_FIX_LASEPARATE_REPEAT="f$(echo ${SCRUB_LAREPEAT_OPT[${FIX_SCRUB_LASEPARATE_USEREPEATIDX}]} | awk '{print $NF}')_${FIX_REPMASK_LAREPEAT_REPEATTRACK}_${FIX_REPMASK_TANMASK_TRACK}_dust"
