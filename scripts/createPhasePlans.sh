...
then 
    ...
    then
        ...
        do            
   		...
   		echo "java -jar ${GATK_PATH} SortVcf -I=${CT_PHASE_OUTDIR}/phase_${CT_PHASE_RUNID}/tmp.vcf -O=${CT_PHASE_OUTDIR}/phase_${CT_PHASE_RUNID}/filtered_phased_variants.vcf -SD=${CT_PHASE_OUTDIR}/phase_${CT_PHASE_RUNID}/ref/refdata-phase/fasta/genome.dict && rm ${CT_PHASE_OUTDIR}/phase_${CT_PHASE_RUNID}/tmp.vcf" >> phase_03_LongrangerBcftoolsConsensus_single_${CONT_DB}.${slurmID}.plan
