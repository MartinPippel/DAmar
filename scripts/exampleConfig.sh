...
COR_CONTIG_CTANALYZE_FUZZYSVLEN=${COR_CONTIG_LAFILTERCTCHAINS_FUZZ}
...
COR_CONTIG_CTANALYZE_READREPEATTRACK=f$(echo ${SCRUB_LAREPEAT_OPT[${FIX_FILT_LAFILTER_REPEAT_IDX}]} | awk '{print $NF}')_${ptype}_${FIX_REPMASK_LAREPEAT_REPEATTRACK}_dust   
